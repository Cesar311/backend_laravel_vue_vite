...
class AuthController extends Controller
{
    ...
    public function verify ($user_id, Request $request){
        ...
        if (!$user->hasVerrifiedEmail()){
            $user->markEmailAsVerrified();
        }

        // Enviar un mensaje en json que indique que el correo a sido verificado
        return redirect()->to('/');
    }
    ...
    public function resend(Request $request){
        ...
        return response()->json(["message" => "Se ha enviado un email de verificación"]);
    }
}
